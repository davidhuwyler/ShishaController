...
typedef enum //LowPowerSampling Frequency
{
    MPU6050_LPSF_1_25HZ           = 0b00,
	MPU6050_LPSF_5HZ              = 0b01,
	MPU6050_LPSF_20HZ             = 0b10,
	MPU6050_LPSF_40HZ             = 0b11,
} mpu6050_lpfs_t;
...
class MPU6050
{
	...
	void setLowPowerSampling(bool enable, bool useGyro, mpu6050_lpfs_t frequency);
