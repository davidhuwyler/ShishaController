...
#include "shell.h"
  ...
  #define McuShell_CONFIG_DEFAULT_SERIAL_RECEIVE_FCT_NAME   shell_RecvCharUSBCDC
    /*!< Function name to read a character and returning ERR_OK if it was successful */

  #define McuShell_CONFIG_DEFAULT_SERIAL_SEND_FCT_NAME   shell_SendCharUSBCDC
    /*!< Function name to send a character and returning ERR_OK if it was successful */

  #define McuShell_CONFIG_DEFAULT_SERIAL_RXAVAIL_FCT_NAME   shell_getInputBufferLength
